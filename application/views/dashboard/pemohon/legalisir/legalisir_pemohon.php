<div class="row">
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Ketentuan Pengajuan Permohonan</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
                1. Pemohon mengajukan <b>surat permohonan legalisir kepada Direktur Politeknik Statistika STIS</b> sesuai dengan format surat baku yang telah ditentukan. Format surat dapat diunduh pada bagian kanan halaman ini.
                ...
                <br /> Legalisir Ijazah dan transkrip hanya akan diberikan sebanyak 2 lembar dan melampirkan <b>surat permohonan izin belajar yang disetujui oleh eselon II dan Kepala Pusdiklat BPS</b>. Contoh surat dapat dilihat diunduh pada bagian kanan halaman ini.
                ...
                <br /> c. Diambil langsung ke kampus Politeknik Statistika STIS oleh perwakilan dibuktikan dengan surat kuasa yang dapat diunduh formatnya pada bagian kanan halaman ini
            ...
            <div class="box-footer clearfix">
                <a href="<?php echo base_url('pemohon/legalisir/pengajuan') ?>"><button type="button" class="pull-right btn btn-default">Ajukan Permohonan
    ...
    <div class="col-md-6">
        <div class="box-header with-border">
            <h3 class="box-title">Kelengkapan Pengajuan Permohonan</h3>
        </div>
        <div class="box-body">
